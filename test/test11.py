...
f = open("G:\\ts03\\BDS_cd", "rb")
f2 = open("G:\\ts03\\bds_data1.txt","w+")
...
f2.close()
                    ...
                    # if bin_data[0:11] == "11100010010" and len(bin_data) == 300:
                    #     Pre = int(bin_data[0:11] ,2)
                    #     Rev = int(bin_data[11:15] ,2)
                    #     FraID = int(bin_data[15:18] ,2)
                    #     if FraID == 5:
                    #         SOW = int(bin_data[18:26] + bin_data[30:42] ,2)
                    #         Rev2 = int(bin_data[42] ,2)
                    #         Pnum = int(bin_data[43:50] ,2)
                    #         print(datestr + " -- " + str(Pnum))
                    #         if Pnum == 10:
                    #             dt_LS = int(bin_data[50:52]+bin_data[60:66] ,2)
                    #             dt_LSF = int(bin_data[66:74] ,2)
                    #             wnstr = bin_data[74:82]
                    #             WN = int(bin_data[74:82] ,2)
                    #             a01 = bin_data[90:112]
                    #             a02 = bin_data[120:130]
                    #             A0_utc = int(bin_data[90:112] + bin_data[120:130] ,2)
                    #             A1_utc = int(bin_data[130:142] + bin_data[150:162],2)
                    #             dnstr = bin_data[162:170]
                    #             DN = int(bin_data[162:170] ,2)
                    #             Rev3 = int(bin_data[170:260] ,2)
                                # print(bin_data)
